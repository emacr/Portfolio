...
const translations = {
  es: {
    ...
    'projects.code_front': 'Ver código frontend',
    'projects.code_back':  'Ver código backend',
  ...
  en: {
    ...
    'projects.code_front': 'View frontend code',
    'projects.code_back':  'View backend code',
